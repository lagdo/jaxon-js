namespace jaxon.tools {
    export class upload {
        ...
        */
        static createIframe(oRequest): boolean {
        ...
        */
        static _initialize(oRequest): boolean {
        ...
        */
        static initialize(oRequest) {
            upload._initialize(oRequest);
