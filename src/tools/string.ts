namespace jaxon.tools.string {
    // export class string {
        ...
        */
        export function doubleQuotes(haystack: string): string|boolean {
        ...
        */
        export function singleQuotes(haystack: string): string|boolean {
            if (typeof haystack == 'undefined') {
                return false;
            }
            return haystack.replace(new RegExp('"', 'g'), "'");
        ...
        */
        export function stripOnPrefix(sEventName: string): string {
        ...
        string - The modified string.
        */
        export function addOnPrefix(sEventName: string): string {
            sEventName = sEventName.toLowerCase();
            if (0 != sEventName.indexOf('on')) {
